"""Sphinx configuration for the baleio documentation."""
...
try:
    from baleio.__meta__ import __version__ as release
...
html_theme_options = {
    ...
    "light_css_variables": {
        "color-brand-primary": "#2f7be5",
        "color-brand-content": "#2f7be5",
    },
    "dark_css_variables": {
        "color-brand-primary": "#63a4ff",
        "color-brand-content": "#63a4ff",
    },
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/ehsndvr/baleio",
            "html": (
                ...
                '1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0016 8c0-4.42-3.58-8-8-8z"/></svg>'
            ),
            "class": "",
        },
    ],
